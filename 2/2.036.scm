;; Q: The procedure accumulate-n is similar to accumulate except that it takes
...
;; (7 8 9)), then the value of (accumulate-n + 0 s) should be the sequence (22
;; 26 30). Fill in the missing expressions in the following definition of
;; accumulate-n:
