;; Q: Consider the change-counting program of section 1.2.2. It would be nice
...
;; The order of the list of coin values will not affect the answer produced by
;; cc. The amount is given as an argument to cc recursively with the same value
;; on each item in the list, so that it will effectively calculate the same
;; value for any ordering of list elements.
