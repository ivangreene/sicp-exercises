...
;; Initially, I think the most natural solution would be a list of numbers representing columns, with each number corresponding to the row that a queen is in for that column.
